                ...
                {isExpanded && (
                  <Card className="absolute top-20 left-1/2 -translate-x-1/2 w-72 bg-black/90 backdrop-blur-lg border-white/30 shadow-xl shadow-white/10 overflow-visible">
                    ...
                    <CardHeader className="pb-2">
                      ...
                      <p className="text-xs text-white/50 tracking-wider uppercase">{item.category}</p>
                    </CardHeader>
                      ...
                      {item.url && (
                        <div className="mt-4 pt-3 border-t border-white/10">
                          <a
                            ...
                            className="flex items-center gap-1 text-xs text-white/70 hover:text-white transition-colors uppercase tracking-wider"
                          >
